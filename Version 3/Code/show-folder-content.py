...
class FolderStructureTool(tk.Tk):
    def __init__(self):
        ...
        self.title("Folder Structure Display Tool - Version 3")
        self.geometry("900x750")
        self.configure(bg="#f5f5f5")
        self.resizable(False, False)

        # Title Label
        self.title_label = tk.Label(self, text="Folder Structure Display Tool - Version 3",
        ...
        self.save_as_label.grid(row=0, column=3, padx=5)
        ...
        self.save_as_menu = ttk.Combobox(self.top_frame, textvariable=self.save_as_var, state="readonly",
                                         values=["None", "Text File", "HTML", "JSON"],
                                         font=("Helvetica", 10), width=15)
        self.save_as_menu.grid(row=0, column=4, padx=10)

        # Text Widget for Folder Structure
        self.text_display = scrolledtext.ScrolledText(self, wrap=tk.WORD, height=20, width=100,
                                                      font=("Courier", 10), bg="#f4f4f9", fg="#333",
    ...
    def display_structure(self, startpath):
        ...
        for root, dirs, files in os.walk(startpath):
            ...
            if hide_node_modules:
                # Remove node_modules directories, case-insensitive check
